...
interface CellProps {
  ...
  onFlag: () => void;
  onChord: () => void;
  isPaintHighlighted?: 'none' | 'red' | 'teal' | 'magenta' | 'tan' | 'deluxe' | 'rainbow';
  onMouseEnter?: () => void;
  onMouseLeave?: () => void;
}
...
export const Cell: React.FC<CellProps> = React.memo(({
  ...
  if (isRevealed) {
    ...
    } else if (isPaintHighlighted === 'teal') {
      cellClass += ' paint-highlighted-teal';
    } else if (isPaintHighlighted === 'magenta') {
      cellClass += ' paint-highlighted-magenta';
    } else if (isPaintHighlighted === 'tan') {
      cellClass += ' paint-highlighted-tan';
    } else if (isPaintHighlighted === 'deluxe') {
      cellClass += ' paint-highlighted-deluxe';
    } else if (isPaintHighlighted === 'rainbow') {
      cellClass += ' paint-highlighted-rainbow';
    }
  }
